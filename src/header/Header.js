    ...
    >
      ...
      <div className="header__left-menu">
        <div className="header__choice-placeholder">
          ...
          <div className="header__book-button">Book</div>
      ...
      <div className="header__right-menu">
        <div
          className={
            isFixedHeader === true && location.pathname !== "/checkout"
              ? "header__visible-searchbar"
              : "header__invisible-searchbar"
          }
        >
        ...
        <div className="header__offer">Offer</div>
