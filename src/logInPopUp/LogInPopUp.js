  ...
  return (
    <div className="loginpopup">
      ...
      <div className="loginpopup__form">
        <div className="loginpopup__welcome">Welcome Back</div>
        ...
        <div className="loginpopup__button-continue">
          <button className="button-continue" type="button" name="button">
            Continue
          </button>
        </div>
        ...
        <div className="loginpopup__button-facebook">
          <button className="button-fb" type="button" name="button">
        ...
        <div className="loginpopup__button-google">
          <button className="button-google" type="button" name="button">
            <div className="google-icon">
              <FontAwesomeIcon icon={faGoogle} color="#ffffff" size="lg" />
            </div>{" "}
        ...
        <div className="loginpopup__sign-up">
          ...
          <button
            className="button-sign-up-or-reset-password"
            type="button"
            name="button"
          >
            Sign Up
