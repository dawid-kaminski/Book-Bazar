		...
		<div className="faq__background">
			<div className="faq">
				...
				<div className="faq__questions">
					...
					<FaqListItem headerText="Website reponse taking time, how to improve?" questionAnswear="At first, Please check your internet connection. We also have some online video tutorials regarding this issue. If the problem remains, Please Open a ticket in the support forum."/>
					<FaqListItem headerText="How do I create a account?" questionAnswear="If you want to open an account for personal use you can do it over the phone or online. Opening an account online should only take a few minutes."/>
				</div>
			</div>
		</div>
	)
