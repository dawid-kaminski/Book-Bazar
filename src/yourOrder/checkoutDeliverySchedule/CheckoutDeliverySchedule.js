...
function CheckoutDeliverySchedule() {
  ...
  return(
    <div className="checkout__delivery-schedule">
      ...
      <CheckoutDeliveryScheduleItem title="11am-2pm" hour="11.00 AM - 2.00 PM" onClickItem={() =>setDeliveryTimeActive(2)} isActive={isDeliveryTimeOpen === 2} />
      <CheckoutDeliveryScheduleItem title="2pm-5pm" hour="2.00 PM - 5.00 PM" onClickItem={() =>setDeliveryTimeActive(3)} isActive={isDeliveryTimeOpen === 3} />
      <CheckoutDeliveryScheduleItem title="5pm-8pm" hour="5.00 PM - 8.00 PM" onClickItem={() =>setDeliveryTimeActive(4)} isActive={isDeliveryTimeOpen === 4} />
      <CheckoutDeliveryScheduleItem title="Next Day" hour="Next Day" onClickItem={() =>setDeliveryTimeActive(5)} isActive={isDeliveryTimeOpen === 5} />
    </div>
  )
}
