...
function AddContactNumber(props) {
  ...
  return (
    <div className="addcontactnumber">
      <div
        className="addcontactnumber__close"
        onClick={onClickOpenAddContactNumber}
      >
      ...
      <div className="addcontactnumber__form">
        <div className="addcontactnumber__placing">
          <div className="addcontactnumber__headline">Add New Contact</div>
          ...
          <div
            className="addcontactnumber__button"
            onClick={onClickSaveAddNewNumber}
            type="submit"
          >
            <button id="button-contact">Save Contact</button>
          </div>
        </div>
      </div>
    </div>
