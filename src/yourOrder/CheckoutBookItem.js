...
function CheckoutBookItem(props) {
  ...
  return(
    <div className="checkout-book-item">
      <div className="checkout-book-item__amount">
        {props.book.amount}
      </div>
      <div className="checkout-book-item__multiply">
        x
      </div>
      <div className="checkout-book-item__title">
        {bookDetails.title}
      </div>
      <div className="checkout-book-item__price">
        ${bookTotalPrice}
      </div>
    </div>
  )
