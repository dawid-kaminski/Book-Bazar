      ...
      <div className="summary__order-sheet">
        ...
        <div className="summary__info">
          <div className="summary__info-order-number-styling">
            <div className="summary__info-order-headline">
              Order Number
            </div>
        ...
        <div className="summary__details">
          <div className="summary__details-headline">
            Order Details
          </div>
          <div className="summary__details-styling">
            <div className="summary__subheading-styling">
              <div className="summary__subheading-main">
                Total Item
              </div>
              <div className="summary__colon">
                :
              </div>
        ...
        <div className="summary__total">
          <div className="summary__total-headline">
            Total Amount
          </div>
