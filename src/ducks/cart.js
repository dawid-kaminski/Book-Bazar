  ...
  reducers: {
    ...
    removeBookFromCart(state, action) {
      ...
      if (selectedBook.amount - bookAmount > 0) {
        state.list[selectedBookIndex] = {
          id: bookId,
          amount: selectedBook.amount - bookAmount,
        };
      } else {
